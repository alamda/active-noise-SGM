...
do
	...
	# then
        ...
        python main.py -cc ${dir}/config_${sim}_eval.txt --root $root_dir --workdir work_dir/dataset --dataset $dataset --snapshot_freq $snapshot_freq --n_train_iters $n_train_iters --ckpt_file final_checkpoint.pth --eval_folder eval --eval_sample --eval_sample_samples 512
