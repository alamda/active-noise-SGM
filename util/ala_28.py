...
class Ala28Dataset(Dataset):
    def __init__(self, num_samples=10, ifname="alanine_dipeptide_28.npy"):
    ...
    def get_data_point(self, batch_size=1):
        with open(self.ifname, "r+b") as f:
            ...
            return torch.from_numpy(data).reshape(28,1,1)

    def __getitem__(self, idx):     
        return self.get_data_point(), 0

if __name__=='__main__':
    myAla28 = Ala28Dataset()